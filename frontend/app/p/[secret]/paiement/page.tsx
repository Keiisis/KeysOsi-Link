...
export default function ProposalPaymentPage({ params }: { params: Promise<{ secret: string }> }) {
    ...
    const handleKkiapay = async () => {
        ...
        try {
            ...
            window.openKkiapayWidget({ amount: proposal.total_amount, position: 'center', key: publicKey, sandbox, phone: customerPhone, email: customerEmail, name: customerName, data: { order_id: oid } })
